...
describe('constructSleepSession', () => {
  ...
  it('should throw if guid is missing', () => {
    ...
    expect(() => constructSleepSession(record)).toThrow(
      'record guid is undefined'
    );
  });
});
...
describe('getAverageTimeInStage', () => {
  ...
  it('should return 0 when no valid records', () => {
    const records: any = [
      { timeAwake: 0, timeLightSleep: 0, timeDeepSleep: 0, timeRemSleep: 0 },
    ];

import {
  getBeginningOfLast14Days,
  getBeginningOfLast30Days,
...
export async function getLast7Days(): Promise<
  ReadRecordsResult<'SleepSession'>
> {
...
/** returns Promise<ReadRecordsResult<"SleepSession">> containing sleep records in the past 14 days */
export async function getLast14Days(): Promise<
  ReadRecordsResult<'SleepSession'>
> {
  return await readRecords('SleepSession', {
    ascendingOrder: false,
...
export async function getLast30Days(): Promise<
  ReadRecordsResult<'SleepSession'>
> {
  return await readRecords('SleepSession', {
    ascendingOrder: false,
...
export async function getBeforeNow(): Promise<
  ReadRecordsResult<'SleepSession'>
> {
  return await readRecords('SleepSession', {
    ascendingOrder: false,

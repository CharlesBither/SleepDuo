...
export default function AlcoholItem(props: AlcoholItemProps) {
        ...
        return (
            <>
                <List.Item
                    ...
                    right={() => <Quantity quantity={props.alcoholQuantity} setQuantityFunc={props.setAlcoholQuantity} setTime={props.setAlcoholTime} />}
                />
                <List.Item
                    title="When did I have my last drink"
                    description={() => <TimeOfDaySegmentedButton timeOfDay={props.alcoholTime} setTimeOfDay={props.setAlcoholTime} disabled={true} />}
                />
            </>
        )
    }
    return (
        <>
            ...
            <List.Item
                title="When did I have my last drink"
                description={() => <TimeOfDaySegmentedButton timeOfDay={props.alcoholTime} setTimeOfDay={props.setAlcoholTime} disabled={false} />}
            />
        </>
    )
}
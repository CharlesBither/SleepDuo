...
export default function DuringSleepSection(props: DuringSleepSectionProps) {
  return (
    <List.Section>
      ...
      <List.Item
        title="Went to sleep at"
        description={getFormattedDateTime(props.record.startTime)}
      />
      <List.Item
        title="Got out of bed at"
        description={getFormattedDateTime(props.record.endTime)}
      />
      <List.Item
        title="Duration"

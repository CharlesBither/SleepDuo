...
export default function ExploreTimeOfDayFilterModal(
  props: ExploreTimeOfDayFilterModalProps
) {
  ...
  return (
    <Portal>
      ...
      >
        <Checkbox.Item
          label="AM"
          status={filterSelection.includes('AM') ? 'checked' : 'unchecked'}
          onPress={() => handleCheckboxPress('AM')}
        />
        <Checkbox.Item
          label="PM"
          status={filterSelection.includes('PM') ? 'checked' : 'unchecked'}
          onPress={() => handleCheckboxPress('PM')}
        />
        <Checkbox.Item
          label="LN"
          status={filterSelection.includes('LN') ? 'checked' : 'unchecked'}
          onPress={() => handleCheckboxPress('LN')}
        />
        <Checkbox.Item
          label="NA"
          status={filterSelection.includes('NA') ? 'checked' : 'unchecked'}
          onPress={() => handleCheckboxPress('NA')}
        />

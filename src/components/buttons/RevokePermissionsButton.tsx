...
export default function RevokePermissionsButton(
  props: RevokePermissionsButtonProps
) {
  const handlePress = async (): Promise<void> => {
    revokeAllPermissions();
    props.showDialogMsg(
      "Please restart the app to finish revoking SleepDuo's access to Health Connect permissions."
    );
  };
  ...
  return (
    <Button disabled={true} style={styles.margin}>
      Revoke permissions
    </Button>
  );
}
